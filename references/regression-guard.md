...
- **趋势追踪**：监控零退化率随迭代次数的变化
- **SWE-CI 发现**：大多数模型的回归率随迭代推进而增加，但回归幅度减小
...
```
迭代 1: 基线 100/100, 变更后 105/105, 零退化 ✅, EvoScore = 0.25
迭代 2: 基线 105/105, 变更后 108/108, 零退化 ✅, EvoScore = 0.15
迭代 3: 基线 108/108, 变更后 110/108, 回归 1个 ❌, EvoScore = -0.01
迭代 4: 基线 108/108, 变更后 112/112, 零退化 ✅, EvoScore = 0.20
```
...
- EvoScore 连续 3 次下降 → 暂停新功能开发，专注质量
- 零退化率低于 80% → 团队质量复盘会议
